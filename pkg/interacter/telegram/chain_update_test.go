...
func TestTelegramChainUpdateNotEnoughArgs(t *testing.T) {
	httpmock.Activate()
	...
	httpmock.RegisterMatcherResponder(
		...
		types.TelegramResponseHasText("Usage: /chain_update &lt;params&gt;"),
	...
	err = interacter.TelegramBot.Trigger("/chain_update", ctx)
	require.NoError(t, err)
...
//nolint:paralleltest // disabled
func TestTelegramChainUpdateChainNameNotProvided(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
	...
	httpmock.RegisterMatcherResponder(
		"POST",
		"https://api.telegram.org/botxxx:yyy/sendMessage",
		types.TelegramResponseHasText("Chain name is not provided!"),
		httpmock.NewBytesResponder(200, assets.GetBytesOrPanic("telegram-send-message-ok.json")))
	...
	ctx := interacter.TelegramBot.NewContext(tele.Update{
		...
		Message: &tele.Message{
			Sender: &tele.User{Username: "testuser", ID: 1},
			Text:   "/chain_update base-denom=unom",
			Chat:   &tele.Chat{ID: 2},
		},
	})
...
//nolint:paralleltest // disabled
func TestTelegramChainUpdateInvalidInvocation(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
...
//nolint:paralleltest // disabled
func TestTelegramChainUpdateNotValid(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
	...
	httpmock.RegisterMatcherResponder(
		"POST",
		"https://api.telegram.org/botxxx:yyy/sendMessage",
		types.TelegramResponseHasText("Invalid data provided: empty base denom"),
		httpmock.NewBytesResponder(200, assets.GetBytesOrPanic("telegram-send-message-ok.json")))
	...
	ctx := interacter.TelegramBot.NewContext(tele.Update{
		...
		Message: &tele.Message{
			Sender: &tele.User{Username: "testuser", ID: 1},
			Text:   "/chain_update name=chain base-denom=",
			Chat:   &tele.Chat{ID: 2},
		},
	})
...
//nolint:paralleltest // disabled
func TestTelegramChainUpdateErrorUpdating(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
	...
	httpmock.RegisterMatcherResponder(
		"POST",
		"https://api.telegram.org/botxxx:yyy/sendMessage",
		types.TelegramResponseHasText("Error fetching chain: custom error"),
		httpmock.NewBytesResponder(200, assets.GetBytesOrPanic("telegram-send-message-ok.json")))
	...
	ctx := interacter.TelegramBot.NewContext(tele.Update{
		...
		Message: &tele.Message{
			Sender: &tele.User{Username: "testuser", ID: 1},
			Text:   "/chain_update name=nomic lcd-endpoint=\"https://api.nomic.quokkastake.io\" pretty-name=\"Nomic\" base-denom=unom bech32-validator-prefix=nomic",
			Chat:   &tele.Chat{ID: 2},
		},
	})
...
//nolint:paralleltest // disabled
func TestTelegramChainUpdateChainErrorInserting(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
...
//nolint:paralleltest // disabled
func TestTelegramChainUpdateChainNotUpdated(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
...
//nolint:paralleltest // disabled
func TestTelegramChainUpdateChainOk(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
