...
func TestTelegramDenomDeleteNotEnoughArgs(t *testing.T) {
	httpmock.Activate()
	...
	httpmock.RegisterMatcherResponder(
		...
		types.TelegramResponseHasText("Usage: /denom_delete &lt;chain name&gt; &lt;denom name&gt;"),
	...
	err = interacter.TelegramBot.Trigger("/denom_delete", ctx)
	require.NoError(t, err)
...
//nolint:paralleltest // disabled
func TestTelegramDenomDeleteErrorDeleting(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
	...
	mock.ExpectExec("DELETE FROM denoms").
...
//nolint:paralleltest // disabled
func TestTelegramDenomDeleteNotFound(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
	...
	httpmock.RegisterMatcherResponder(
		"POST",
		"https://api.telegram.org/botxxx:yyy/sendMessage",
		types.TelegramResponseHasText("Denom was not found!"),
		httpmock.NewBytesResponder(200, assets.GetBytesOrPanic("telegram-send-message-ok.json")))
...
//nolint:paralleltest // disabled
func TestTelegramDenomOk(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
	...
	httpmock.RegisterMatcherResponder(
		"POST",
		"https://api.telegram.org/botxxx:yyy/sendMessage",
		types.TelegramResponseHasText("Successfully deleted denom!"),
		httpmock.NewBytesResponder(200, assets.GetBytesOrPanic("telegram-send-message-ok.json")))
